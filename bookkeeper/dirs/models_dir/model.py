...
class Model():
    ...
    def delete_category(self, c_id):
        ...
        if c_parent_id != None:
            for expense in expenses:
                expense.reassign_category(Category.get_category_by_id(c_parent_id))
    ...
    def edit_expense_category(self, e_id, c_id):
        e = Expense.get_expense_by_id(e_id)
        c = Category.get_category_by_id(c_id)
        e.reassign_category(c)
